...
class GridMaker:
    ...
    def make_grid(self):
        ...
        self.grid.to_file("siatka_24.geojson", driver="GeoJSON")
    ...
    def save_results(self):
        self.merged_geojson.to_file("merge_1_geojson.geojson", driver="GeoJSON")
...
geojson_1 = GridMaker(150, "probny.geojson")
geojson_1.do()
